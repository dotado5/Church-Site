...
export const DescriptionBox: React.FC = () => {
  return (
    <section className=" flex w-[1300px] h-[700px] mx-auto mt-[4em]">
      <div>
        <h5 className="text-button font-medium text-[20px]">PASTOR’S CORNER</h5>
        ...
        <p className="text-white text-[14px] font-normal mb-2 w-[780px]">
          ...
          I stand before you as the coordinator of this esteemed teens' church.{" "}
          <br />
          <br />
          ...
          of faith. We understand the challenges that teenagers face in today's
          rapidly changing world, and we are dedicated to creating an
          environment that addresses these challenges with wisdom, compassion,
          and relevance. <br /> <br /> I encourage each of you to actively
          participate in the various programs, discussions, and activities that
          MOJ offers. Your engagement is not only welcomed but crucial to the
          vibrancy and success of our community. Feel free to reach out to me or
          our dedicated team with any questions, suggestions, or concerns you
          may have. <br /> <br /> Welcome to Minds of Josiah, where faith is
          cultivated, minds are enriched, and community thrives.
        </p>
